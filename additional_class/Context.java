    ...
    public void C(int ruleNo)
    {
        ...
        switch(ruleNo)
        {
            ...
            case 7:
                ...
                break;
            case 8:
                typeStack.push(Integer.valueOf(symbolHash.find(currentStr).getIdType()));
                break;
            case 9:
                typeStack.push(Integer.valueOf(Bucket.INTEGER));
                break;
            case 10:
                typeStack.push(Integer.valueOf(Bucket.BOOLEAN));
                break;
            case 11:
                typeStack.pop();
                break;
            ...
            case 14:
                ...
                typeStack.push(Integer.valueOf(temp));
                break;
            case 15:
